---
title: "Donator Perks"
description: "Donator perks are rewards given to those who choose to donate to Lush."
icon: "dollar-sign"
---

## How to obtain Donator Perks

Donator perks can be purchased via **server subscriptions** in our [Support Server](https://discord.gg/Gak6Yb5t39) which can be found at the top of the channel list labeled as **Server Shop**.

<Frame>
  ![](/images/overview/donator-perks/subscriptions.png)
</Frame>
  ...
  <Tab title="Tier 3">
    ...
    <AccordionGroup>
      ...
      <Accordion title="Instagram Notifications">
        ...
        <Tip>
          More information on this command can be found in the [Social Notifications](/integrations/social-notifications) section.
        </Tip>
        <CodeGroup>
