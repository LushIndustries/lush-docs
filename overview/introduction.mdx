---
title: "Introduction"
description: "Learn how to set up lush in your server or enhance your everyday use with commands & more."
...
<CardGroup cols={2}>
  <Card title="Security Setup" icon="hammer" href="/security">
    Quickly configure your server to use lush's advanced moderation system.
  </Card>
  ...
  <Card title="Integrations" icon="share-nodes" href="/integrations">
    Seamlessly integrate your favorite platforms directly into your server through lush.
  </Card>
