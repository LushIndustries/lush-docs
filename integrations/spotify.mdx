...
If you no longer wish to use the **Spotify integration**, you can use the `spotify logout` command to disconnect your account from lush.

## Controlling your Spotify Playback

<Warning>
  You must be a **Spotify Premium** subscriber to control your playback with lush.
</Warning>
