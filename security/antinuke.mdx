...
<AccordionGroup>
  ...
  <Accordion title="Command Detection">
    Whether lush commands should be counted towards the threshold. (e.g. `,ban`)
...
<AccordionGroup>
  <Accordion title="Punishing members for changing the vanity URL">
    ...
    <Warning>
      lush can not change the vanity URL back to the original due to Discord limitations.
    </Warning>
    <CodeGroup>
