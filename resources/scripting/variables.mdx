---
title: "Variables"
description: "All available variables within lush."
icon: "signature"
---

These variables are accessible throughout lush and can be used in any command context which contains a `message` or `embed code` parameter (e.g. `welcome`, `leave` & `goodbye`)
