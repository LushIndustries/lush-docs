...
<AccordionGroup>
  <Accordion title="Changing the host">
    ...
    ```javascript Example
    ,giveaway edit host .../channels/... @lockfile
    ```
  ...
  <Accordion title="Changing the prize">
    ...
    ```javascript Example
    ,giveaway edit prize .../channels/... lush whitelist
    ```
...
<AccordionGroup>
  ...
  <Accordion title="Changing the thumbnail">
    ...
    ```javascript Example
    ,giveaway edit thumbnail .../channels/... https://lush.dev/lush.png
    ```
  ...
  <Accordion title="Changing the image">
    ...
    ```javascript Example
    ,giveaway edit image .../channels/... https://lush.dev/lush.png
    ```
...
<AccordionGroup>
  <Accordion title="Setting a required role">
    ...
    <Info>
      If you no longer want to require roles, you can re-run the command without a role.
    </Info>
    
    <Warning>
      You can use multiple roles by separating them with a comma (`,`).
    </Warning>
  ...
  <Accordion title="Setting a required level">
    ...
    <Warning>
      This relies on bleed's [leveling system](/configuration/level-rewards), not other bots.
    </Warning>
...
<Info>
  This will display past and active giveaways.
</Info>